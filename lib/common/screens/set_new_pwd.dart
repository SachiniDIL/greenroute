...
import 'package:greenroute/common/services/password_reset_service.dart';
...
class _SetNewPwdState extends State<SetNewPwd> {
  ...
  PasswordResetService(); // Use the service
  ...
  Future<void> _resetPassword() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        await _passwordResetService.updatePassword(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      obscureText: true,
                      validator:
                      Validators.validatePassword, // Password validation
                    ),
                    const SizedBox(height: 20),
